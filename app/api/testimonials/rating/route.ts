...
// GET /api/testimonials/rating - Get rating summary
export async function GET(request: NextRequest) {
  try {
    ...
    const validatedParams = ratingSchema.parse(queryParams);
    ...
    console.error('Error in GET /api/testimonials/rating:', error);
    return NextResponse.json(

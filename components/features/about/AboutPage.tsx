        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              New Zealand&apos;s premier platform connecting event managers with
              trusted contractors
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg p-8">
                  ...
                  <p className="text-gray-700 mb-4">
                    To revolutionize event planning in New Zealand by creating a
                    trusted, efficient platform that connects event managers
                  ...
                  <p className="text-gray-700">
                    ...
                    known for quality, reliability, and innovation in connecting
                    event professionals.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  ...
                  <p className="text-gray-600">
                    From Northland to Southland, we connect event professionals
